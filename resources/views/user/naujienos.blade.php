 ...
 @include('user/layouts/header')
  ...
  <section id="projects" class="projects-section bg-light">
    <div class="container">
        ...
        <div class="container d-flex h-100 align-items-center">
      <div class="mx-auto text-center">
      <h1 class="mx-auto my-0 text-uppercase">Naujienos</h1>
      <br>
      <br>
      <br>
      </div>
...
@foreach($naujienos as $naujiena)
      ...
      <div class="row justify-content-center no-gutters mb-5 mb-lg-0">
        <div class="col-lg-6">
          <img class="img-fluid" src="{{ Storage::url("$naujiena->naujienosnuotrauka") }}" alt="">
        </div>
        <div class="col-lg-6">
          <div class="bg-black text-center h-100 project">
            <div class="d-flex h-100">
              <div class="project-text w-100 my-auto text-center text-lg-left">
                <h4 class="text-white">{{ $naujiena->naujienospavadinimas }}</h4>
                <p class="mb-0 text-white-50">
                   {{ $naujiena->naujienostekstas }} 
                   </p>
