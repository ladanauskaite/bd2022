...
@foreach($paslaugos as $paslauga)
      ...
      <div class="row justify-content-center no-gutters mb-5 mb-lg-0">
        <div class="col-lg-6">
            <img class="img-fluid" src="{{ Storage::url("$paslauga->paslaugosnuotrauka") }}" alt="">
        </div>
        <div class="col-lg-6">
          <div class="bg-black text-center h-100 project">
            <div class="d-flex h-100">
              <div class="project-text w-100 my-auto text-center text-lg-left">
                <h4 class="text-white">{{ $paslauga->paslaugospavadinimas }}</h4>
                <p class="mb-0 text-white-50">{{ $paslauga->paslaugostekstas }}</p>
