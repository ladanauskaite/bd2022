          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Sukurti darbo skelbimą</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" action="{{ route('skelbimai.store') }}" method="post" enctype="multipart/form-data">
                 <input type="hidden" name="_token" value="{{ csrf_token() }}">
                 
                <div class="card-body">
                  <div class="form-group">
                    <label for="skelbimopavadinimas">Darbo skelbimo pavadinimas</label>
                    <input type="text" class="form-control" id="skelbimopavadinimas" name="skelbimopavadinimas" placeholder="Įrašyti darbo skelbimo pavadinimą...">
                  </div>
                  <div class="form-group">
