...
@endif
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" action="{{ route('naujienos.store') }}" method="post"  enctype="multipart/form-data">
                 <input type="hidden" name="_token" value="{{ csrf_token() }}">

                <div class="card-body">
                  <div class="form-group">
                    <label for="naujienospavadinimas">Naujienos pavadinimas</label>
                    <input type="text" class="form-control" id="naujienospavadinimas" name="naujienospavadinimas" placeholder="Įrašyti naujienos pavadinimą...">
                  </div>
                  <div class="form-group">
